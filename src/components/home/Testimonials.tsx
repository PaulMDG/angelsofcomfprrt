...
const quotes = [
  {
    q: "They didn't just care for my mother — they cared for our entire family. The peace of mind we found is something I never thought possible after Dad passed.",
    n: "Margaret K.",
    r: "Daughter, Bethesda",
  },
  {
    q: "After my husband's stroke, I was drowning. Angels of Comfort gave us back our evenings together. Their caregiver feels like family now.",
    n: "Eleanor R.",
    r: "Wife, Silver Spring",
  },
  {
    q: "What struck me most was the patience. With Mom's dementia, every day is unpredictable — they meet her exactly where she is, every single time.",
    n: "James A.",
    r: "Son, Rockville",
  },
];
              ...
              <Reveal key={q.n} delay={i * 0.08}>
                <figure className="border-l-2 border-[var(--gold)] pl-8">
                  ...
                  <figcaption className="mt-6 flex items-center gap-3">
                    ...
                    <span className="text-[13px] text-[var(--warm-gray)] font-light">— {q.r}</span>
                  </figcaption>
                </figure>
              </Reveal>
            ))}
